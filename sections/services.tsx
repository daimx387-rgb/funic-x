    ...
    <section id="services" className="section relative overflow-hidden">
      <div className="container-x">
        ...
        <Reveal className="max-w-[780px]">
          <span className="inline-flex items-center gap-2.5 font-mono text-[12px] font-medium uppercase tracking-[0.18em] text-ink-mute dark:text-ink-mute">
          ...
          <motion.h2
            ...
            className="mt-3 text-[clamp(1.4rem,2.4vw+4px,2.1rem)] font-semibold leading-[1.06] tracking-[-0.04em] text-ink dark:text-paper"
          >
            {[
              "AI",
              "solutions",
          ...
          <p className="mt-3 max-w-[520px] text-[13.5px] leading-[1.5] text-ink-soft dark:text-ink-mute">
        ...
        {/* Rows */}
        <Stagger className="mt-10 border-b border-line" stagger={0.09}>
          {services.map((s) => (
...
function ServiceRow({ service: s }: { service: Service }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex cursor-pointer items-center gap-4 border-t border-line px-2 py-5 transition-colors duration-500 hover:bg-mist/50 dark:hover:bg-white/[0.02] sm:gap-6 sm:px-4 sm:py-5"
    >
      ...
      {/* Number */}
      <span className="relative w-[38px] shrink-0 font-mono text-[12px] font-medium tracking-[0.1em] text-ink-mute transition-all duration-500 group-hover:text-[#6d4aff] group-hover:[text-shadow:0_0_22px_rgba(109,74,255,0.55)] sm:w-[52px] sm:text-[14px]">
        {s.num}
      </span>

      {/* Title + description */}
      <div className="relative min-w-0 flex-1">
        <h3 className="relative text-[clamp(1.05rem,1.6vw+3px,1.5rem)] font-semibold tracking-[-0.03em] text-ink dark:text-paper">
        ...
        <p className="mt-0.5 max-w-[540px] text-[13.5px] leading-[1.45] text-ink-soft dark:text-ink-mute">
          {s.desc}
        </p>
      </div>
      ...
      <ArrowRight
        strokeWidth={1.5}
        className="relative h-5 w-5 shrink-0 text-ink-soft transition-all duration-300 group-hover:translate-x-1.5 group-hover:text-[#6d4aff] dark:text-ink-mute dark:group-hover:text-[#a78bfa]"
      />
    </motion.div>
  );
}
